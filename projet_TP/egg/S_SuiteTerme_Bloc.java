...
int [] sync= new int[0];
  ...
  private void regle33() throws Exception {
	...
	//appel
if  (att_eval)	  action_auto_inh_33(x_2, x_3, x_5);
	x_2.analyser() ;
	x_3.analyser() ;
if  (att_eval)	  action_ast_inh_33(x_2, x_3, x_5);
	x_5.analyser() ;
if  (att_eval)	  action_ast_syn_33(x_2, x_3, x_5);
  }
...
private void action_auto_inh_33(S_Additif_Bloc x_2, S_Terme_Bloc x_3, S_SuiteTerme_Bloc x_5) throws Exception {
try {
// instructions
...
private void action_ast_syn_33(S_Additif_Bloc x_2, S_Terme_Bloc x_3, S_SuiteTerme_Bloc x_5) throws Exception {
try {
// instructions
...
private void action_ast_inh_33(S_Additif_Bloc x_2, S_Terme_Bloc x_3, S_SuiteTerme_Bloc x_5) throws Exception {
try {
// instructions
