...
if  (att_eval)	  action_auto_inh_32(x_2, x_4);
	x_2.analyser() ;
if  (att_eval)	  action_ast_inh_32(x_2, x_4);
	x_4.analyser() ;
if  (att_eval)	  action_ast_syn_32(x_2, x_4);
  }
private void action_ast_syn_32(S_Terme_Bloc x_2, S_SuiteTerme_Bloc x_4) throws Exception {
try {
// instructions
...
private void action_auto_inh_32(S_Terme_Bloc x_2, S_SuiteTerme_Bloc x_4) throws Exception {
try {
// instructions
...
private void action_ast_inh_32(S_Terme_Bloc x_2, S_SuiteTerme_Bloc x_4) throws Exception {
try {
// instructions
