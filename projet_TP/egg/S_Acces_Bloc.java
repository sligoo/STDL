...
int [] sync= new int[0];
  ...
  private void regle49() throws Exception {
	...
	//appel
if  (att_eval)	  action_auto_inh_49(x_3, x_5);
	x_2.analyser(LEX_Bloc.token_point);
	x_3.analyser(LEX_Bloc.token_identificateur);
if  (att_eval)	  action_inh_49(x_3, x_5);
	x_5.analyser() ;
if  (att_eval)	  action_ast_49(x_3, x_5);
  }
...
if  (att_eval)	  action_ast_48();
  ...
  private void regle47() throws Exception {
	...
	//appel
if  (att_eval)	  action_auto_inh_47(x_3, x_6);
	x_2.analyser(LEX_Bloc.token_crochet_ouvrant);
	x_3.analyser() ;
	x_4.analyser(LEX_Bloc.token_crochet_fermant);
if  (att_eval)	  action_inh_47(x_3, x_6);
	x_6.analyser() ;
if  (att_eval)	  action_ast_47(x_3, x_6);
  }
private void action_ast_47(S_Expression_Bloc x_3, S_Acces_Bloc x_6) throws Exception {
try {
// instructions
...
private void action_ast_49(T_Bloc x_3, S_Acces_Bloc x_5) throws Exception {
try {
// instructions
...
private void action_inh_47(S_Expression_Bloc x_3, S_Acces_Bloc x_6) throws Exception {
try {
// instructions
...
private void action_auto_inh_47(S_Expression_Bloc x_3, S_Acces_Bloc x_6) throws Exception {
try {
// instructions
...
private void action_auto_inh_49(T_Bloc x_3, S_Acces_Bloc x_5) throws Exception {
try {
// instructions
...
private void action_inh_49(T_Bloc x_3, S_Acces_Bloc x_5) throws Exception {
try {
// instructions
