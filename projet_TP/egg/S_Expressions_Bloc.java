...
int [] sync= new int[0];
  ...
  private void regle73() throws Exception {
	...
	//appel
if  (att_eval)	  action_auto_inh_73(x_2, x_3);
	x_2.analyser() ;
	x_3.analyser() ;
if  (att_eval)	  action_ast_73(x_2, x_3);
  }
private void action_auto_inh_73(S_Expression_Bloc x_2, S_SuiteExpressions_Bloc x_3) throws Exception {
try {
// instructions
...
private void action_ast_73(S_Expression_Bloc x_2, S_SuiteExpressions_Bloc x_3) throws Exception {
try {
// instructions
