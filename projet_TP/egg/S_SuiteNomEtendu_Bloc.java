...
if  (att_eval)	  action_ast_27();
  ...
  private void regle26() throws Exception {
	...
	//appel
if  (att_eval)	  action_auto_inh_26(x_5);
	x_2.analyser(LEX_Bloc.token_crochet_ouvrant);
	x_3.analyser(LEX_Bloc.token_crochet_fermant);
if  (att_eval)	  action_inh_26(x_5);
	x_5.analyser() ;
if  (att_eval)	  action_ast_26(x_5);
  }
private void action_ast_26(S_SuiteNomEtendu_Bloc x_5) throws Exception {
try {
// instructions
...
private void action_auto_inh_26(S_SuiteNomEtendu_Bloc x_5) throws Exception {
try {
// instructions
...
private void action_inh_26(S_SuiteNomEtendu_Bloc x_5) throws Exception {
try {
// instructions
