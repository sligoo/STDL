...
int [] sync= new int[0];
  ...
  private void regle56() throws Exception {
	...
	//appel
if  (att_eval)	  action_auto_inh_56(x_2, x_3);
	x_2.analyser() ;
	x_3.analyser(LEX_Bloc.token_identificateur);
	x_4.analyser(LEX_Bloc.token_point_virgule);
if  (att_eval)	  action_ast_56(x_2, x_3);
  }
private void action_auto_inh_56(S_Type_Bloc x_2, T_Bloc x_3) throws Exception {
try {
// instructions
...
private void action_ast_56(S_Type_Bloc x_2, T_Bloc x_3) throws Exception {
try {
// instructions
