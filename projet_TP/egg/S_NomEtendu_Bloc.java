...
if  (att_eval)	  action_inh_23(x_4);
	x_4.analyser() ;
if  (att_eval)	  action_ast_23(x_4);
  }
...
if  (att_eval)	  action_inh_24(x_4);
	x_4.analyser() ;
	x_5.analyser(LEX_Bloc.token_parenthese_fermante);
if  (att_eval)	  action_ast_24(x_4);
  }
...
if  (att_eval)	  action_inh_25(x_2, x_4);
	x_4.analyser() ;
if  (att_eval)	  action_ast_25(x_2, x_4);
  }
private void action_ast_25(T_Bloc x_2, S_SuiteNomEtendu_Bloc x_4) throws Exception {
try {
// instructions
...
private void action_inh_25(T_Bloc x_2, S_SuiteNomEtendu_Bloc x_4) throws Exception {
try {
// instructions
...
private void action_auto_inh_23(S_NomEtendu_Bloc x_4) throws Exception {
try {
// instructions
...
private void action_inh_24(S_NomEtendu_Bloc x_4) throws Exception {
try {
// instructions
x_4.att_type=this.att_type;
...
private void action_inh_23(S_NomEtendu_Bloc x_4) throws Exception {
try {
// instructions
...
private void action_auto_inh_24(S_NomEtendu_Bloc x_4) throws Exception {
try {
// instructions
x_4.att_factory=this.att_factory;
...
private void action_auto_inh_25(T_Bloc x_2, S_SuiteNomEtendu_Bloc x_4) throws Exception {
try {
// instructions
x_4.att_factory=this.att_factory;
...
private void action_ast_23(S_NomEtendu_Bloc x_4) throws Exception {
try {
// instructions
...
private void action_ast_24(S_NomEtendu_Bloc x_4) throws Exception {
try {
// instructions
this.att_nom=x_4.att_nom;
this.att_ast=x_4.att_ast;
